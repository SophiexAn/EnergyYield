...
Irr_spectra_clear_sky_wavelength         = 280:1:4000;  % Wavelength in nm
Irr_spectra_clear_sky_direct_normal      = zeros(365*24,length(280:1:4000));
Irr_spectra_clear_sky_diffuse_horizontal = zeros(365*24,length(280:1:4000));
Irr_spectra_clear_sky_direct_horizontal  = zeros(365*24,length(280:1:4000));
